...
public class SensorPostDTOValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return SensorPostDTO.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        SensorPostDTO dto = (SensorPostDTO) target;
    ...
    private static void validateDescription(Errors errors, SensorPostDTO dto) {
    ...
    private static void validateLocation(Errors errors, SensorPostDTO dto) {
    ...
    private static void validateRange(Errors errors, SensorPostDTO dto) {
    ...
    private static void validateModel(Errors errors, SensorPostDTO dto) {
    ...
    private static void validateName(Errors errors, SensorPostDTO dto) {
